...
/**
 * Sunmi Inner Thermal Printer AIDL Interface for Sunmi V1s/V2/V2 Pro/T2
 */
interface IWoyouService {
    ...
    int getPrinterPaper();
    void getPrinterPaperAsync(in ICallback callback);
    ...
    void commitPrint(in ICallback callback);
